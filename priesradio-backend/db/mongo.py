...
def get_digitec():
    return _pool.get_collection('digitec')

def get_interdiscount():
    return _pool.get_collection('interdiscount')

def get_brack():
    return _pool.get_collection('brack')

def get_all_stores():
    """Retourne [(fonction_collection, nom_store), ...]"""
    return [
        (get_digitec, 'Digitec'),
        (get_interdiscount, 'Interdiscount'),
        (get_brack, 'Brack'),
    ]
