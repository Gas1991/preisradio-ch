...
MONGODB_CONFIG = {
    'digitec': {
        ...
        'collection': config('MONGODB_DIGITEC_COLLECTION', default='DB'),
    },
    'interdiscount': {
        'uri':        config('MONGODB_INTERDISCOUNT_URI'),
        'db':         config('MONGODB_INTERDISCOUNT_DB', default='Interdiscount'),
        'collection': config('MONGODB_INTERDISCOUNT_COLLECTION', default='DB'),
    },
    'brack': {
        'uri':        config('MONGODB_BRACK_URI'),
        'db':         config('MONGODB_BRACK_DB', default='Brack'),
        'collection': config('MONGODB_BRACK_COLLECTION', default='DB'),
    },
}
